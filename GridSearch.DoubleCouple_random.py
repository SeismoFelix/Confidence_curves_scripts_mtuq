...
if __name__=='__main__':
    ...
    path_data=    fullpath('/Users/felix/Documents/POSTDOC/INVESTIGACION/MTUQ_CONFIDENCE/20171201023244/*.[zrt]')
    path_weights= fullpath('/Users/felix/Documents/POSTDOC/INVESTIGACION/MTUQ_CONFIDENCE/20171201023244/weights.dat')
    ...
    origin = Origin({
        'time': '2017-12-01T02:32:44.000000Z',
        'latitude': 30.734,
        'longitude': 57.39,
        'depth_in_m': 6000.0,
        })
    ...
    if comm.rank==0:
        ...
        omega.plot_rho_vs_V('rho_vs_v.png', results, unc, var=50, nbins=40)
        omega.probability_vs_omega('prob_vs_omega.png', results)
        omega.misfit_vs_omega('misfit_vs_omega.png', results)
